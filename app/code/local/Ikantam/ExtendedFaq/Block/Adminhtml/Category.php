...
class Ikantam_ExtendedFaq_Block_Adminhtml_Category extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    protected function _construct()
    {
        $this->_blockGroup = 'extendedfaq';
        $this->_controller = 'adminhtml_category';
		$this->_headerText = Mage::helper("extendedfaq")->__("Manage FAQ Categories");
		$this->_addButtonLabel = Mage::helper("extendedfaq")->__("Add FAQ Category");
    }
}
