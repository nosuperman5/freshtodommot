...
class Magestore_Fblogin_IndexController extends Mage_Core_Controller_Front_Action
{
    public function indexAction(){
		...
		$this->_redirectUrl(Mage::getBaseUrl());//add them fix new //Mage::helper('customer')->getDashboardUrl()
    }
		...
		protected function _loginPostRedirect()
    {
        ...
        if (!$session->getBeforeAuthUrl() || $session->getBeforeAuthUrl() == Mage::getBaseUrl()) {
            ...
            $session->setBeforeAuthUrl(Mage::getBaseUrl()); //Mage::helper('customer')->getDashboardUrl()
