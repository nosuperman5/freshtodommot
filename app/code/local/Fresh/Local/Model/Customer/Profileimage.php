<?php 
class Fresh_Local_Model_Customer_Profileimage extends Mage_Core_Model_Abstract{
	...
	public function getProfileimageUrl($file) {
        return Mage::getBaseUrl('media') . 'customer' . $file;
    }
