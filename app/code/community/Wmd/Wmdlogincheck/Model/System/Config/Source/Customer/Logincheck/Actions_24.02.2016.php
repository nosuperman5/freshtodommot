    ...
    {		
		if (!$this->_options){
            $this->_options = array(
                ...
                array('value' => '/customer_account_forgotpassword/', 'label' => Mage::helper('wmdlogincheck')->__('Customer Account Forgot Password')),				array('value' => '/customer_account_changepassword/', 'label' => Mage::helper('wmdlogincheck')->__('Customer Account Change Password')),
